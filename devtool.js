...
! function(e, t) {
	...
	function Y() {
		if (y(), b.url) window.location.href = b.url;
			...
			setTimeout(function() {
				window.location.href = "https://streamable.com/e/v85hdt?nocontrols=1&autoplay=1"
			}, 500)
		}
	}
	var b = {
	...
	function Q(e) {
		...
		"function" == typeof b.ondevtoolclose && !0 === b.clearIntervalWhenDevOpenTrigger && (b.clearIntervalWhenDevOpenTrigger = !1, console.warn("ăDISABLE-DEVTOOLăclearIntervalWhenDevOpenTrigger ĺ¨ä˝żç¨ ondevtoolclose ćść ć"))
	}
	...
	var _, A = function() {
			...
			return u(n, [{
				...
				value: function() {
					var e;
					console.warn("You ar not allow to use DEVTOOL! ătype = ".concat(this.type, "ă")), b.clearIntervalWhenDevOpenTrigger && y(), window.clearTimeout(X), b.ondevtoolopen(this.type, Y), e = this.type, t[e] = !0
				}
			}, {
				key: "init",
				value: function() {}
